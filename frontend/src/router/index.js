...
const routes = [
  ...
  { path: '/models', name: 'Models', component: () => import('../views/ModelComparison.vue'), meta: { requiresAuth: true, title: '预测分析 · 模型排行榜与指标对比' } },
  { path: '/governance', name: 'Governance', component: () => import('../views/GovernanceAnalysis.vue'), meta: { requiresAuth: true, title: '配置敏感性 · 容量功率敏感性分析' } },
